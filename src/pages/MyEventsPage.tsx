  ...
  return (
    <div className="events-page">
      <header className="events-header">
        <Link to="/profile" className="events-back">← Profile</Link>
        <h1>My events</h1>
        <p className="events-sub">Past and upcoming events</p>
        <Link to="/profile/events/new" className="events-create-btn">Create New Event</Link>
      </header>
